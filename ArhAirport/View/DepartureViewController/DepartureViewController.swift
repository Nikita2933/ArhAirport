...
class DepartureViewController: UIViewController, MenuBarDelegate {
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(PageDepartureCollectionCell.self, forCellWithReuseIdentifier: cellID)
...
extension DepartureViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! PageDepartureCollectionCell
...
extension DepartureViewController: UICollectionViewDelegateFlowLayout {
